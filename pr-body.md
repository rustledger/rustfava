Automated update of rustledger to v0.20.1 — **held for human review** (draft, no auto-merge) because:
...
See [rustledger v0.20.1 release notes](https://github.com/rustledger/rustledger/releases/tag/v0.20.1). Context: #218 / #219 / #220.
