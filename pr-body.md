Automated update of rustledger to v0.20.0 — **held for human review** (draft, no auto-merge) because:
...
- Bumped `_WIT_VERSION` to `3.3.0` (if it changed)
...
See [rustledger v0.20.0 release notes](https://github.com/rustledger/rustledger/releases/tag/v0.20.0). Context: #218 / #219 / #220.
