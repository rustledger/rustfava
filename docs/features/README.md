...
Extracted from the actual code surfaces (reports, routes, API, options, engine)
at v1.31/main, 2026-07.
...
- Engine behavior is included where the user can see it (error messages, booking
  outcomes, plugin effects), excluded where they cannot.
